      ...
      {/* </Link>   */}
        ...
        <div className={classes.textimage_textcontent}>
          <div className={classes.content}>
            <h2 className={classes.imagetext_title} style={{paddingBottom:'10px'}}> Second-hand jeans at the perfect price</h2>
          ...
          <p> Wait too long and someone else will snatch your jeans...</p> 
            <button style={{marginTop:'10px'}}>Get your discounted jeans</button>
          </div>
        </div>
    </div>  </div>
  )
